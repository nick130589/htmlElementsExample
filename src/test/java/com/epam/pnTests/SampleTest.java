...
//        initialize of driver e.g.Chrome
    ...
    public void checkSearchOnHomePage() {
        ...
        searchResultsPage.isPageLoaded();
        searchResultsPage.getSearchResultItemsNames().forEach(itemName -> assertThat(itemName.contains("Nintendo"))
                .as("Found item, that shouldn't be is search results: %s", itemName).isTrue());
    }
